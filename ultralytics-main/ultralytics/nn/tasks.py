...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            mlp_ratio = args[3]
            drop_path = args[4]
            args = [c1, stage, att_kernel, mlp_ratio, drop_path]
            ...
            att_kernel = args[3]
            mlp_ratio = args[4]
            drop_path = [i * 0.2 / (depth-1) for i in range(depth)]
            args = [c1, stage, depth, att_kernel, mlp_ratio, drop_path]
        else:
            c2 = ch[f]
